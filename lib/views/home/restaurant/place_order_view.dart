...
class PlaceOrderScreenForRestaurant extends StatefulWidget {
  String address;
  String address1;
  PlaceOrderScreenForRestaurant({this.address, this.address1});
  @override
  _PlaceOrderScreenForRestaurantState createState() => _PlaceOrderScreenForRestaurantState();
}

class _PlaceOrderScreenForRestaurantState extends State<PlaceOrderScreenForRestaurant> {
